let self = module.exports = {
    appSettings: function() {
        ...
        //Controllers
        const FarmersController = require('./controllers/farmersController.js');
        const farmers = new FarmersController(config);

        const AgencyController = require('./controllers/agencyController.js');
